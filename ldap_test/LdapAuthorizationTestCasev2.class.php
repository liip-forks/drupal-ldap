...
class LdapAuthorizationTestCasev2 extends DrupalWebTestCase {
  ...
  function prepTestData() {
   ...
   // with test data stored in features, need to get server properties from ldap_server properties
      ldap_server_module_load_include('inc', $this->featureName, $this->featureName . '.ldap_servers');
      ldap_server_module_load_include('inc', $this->featureName, 'fake_ldap_server_data');
